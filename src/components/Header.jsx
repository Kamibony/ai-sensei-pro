...
const Header = ({ userEmail, userData, onNavigateToDashboard }) => {
    ...
    // Tato funkce je klíčová
    const handleLogout = async () => {
        // Nejdříve odhlásí uživatele
        await signOut(auth);
        // Poté natvrdo obnoví celou stránku
        ...
        <header className="bg-white shadow-md">
            <div className="container mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
                ...
                <div className="flex items-center">
                    ...
                    <button onClick={handleLogout} className="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-all duration-300">Odhlásit se</button>
                </div>
            </div>
        </header>
    );
