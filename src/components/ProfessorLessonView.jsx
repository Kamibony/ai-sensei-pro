...
const ProfessorLessonView = ({ lessonId, onBack }) => {
    ...
    const handleSave = async () => {
        ...
        setSaveMessage('MateriÃ¡ly byly ÃºspÄ›Å¡nÄ› uloÅ¾eny!');
        setTimeout(() => setSaveMessage(''), 3000);
    }

    return (
        <div className="container mx-auto">
            <button onClick={onBack} className="mb-6 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg">&larr; ZpÄ›t</button>
            <div className="bg-white p-8 rounded-xl shadow-lg">
                ...
                <div className="border-b mb-6">
                    ...
                    <button onClick={() => setActiveTab('interactions')} className={`py-2 px-4 ${activeTab === 'interactions' ? 'border-b-2 border-blue-600 font-semibold' : ''}`}>Interakce StudentÅ¯</button>
                </div>
                ...
                {activeTab === 'edit' && (
                    <>
                        ...
                        <div className="mt-8 text-right">
                            ...
                            <button onClick={handleSave} className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-8 rounded-lg text-lg">UloÅ¾it materiÃ¡ly</button>
                        </div>
                    </>
                )}
